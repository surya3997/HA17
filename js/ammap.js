(function() {
    ...
    d.makeChart = function(a, b, c) {
        ...
        d.extend(g, b);
        d.isReady ? isNaN(c) ? g.write(a) : setTimeout(function() { d.realWrite(g, a) }, c) : d.ready(function() { isNaN(c) ? g.write(a) : setTimeout(function() { d.realWrite(g, a) }, c) });
        return g
    };
...
(function() {
    ...
    d.callMethod = function(a, b) { var c; for (c = 0; c < b.length; c++) { var e = b[c]; if (e) { if (e[a]) e[a](); var d = e.length; if (0 < d) { var g; for (g = 0; g < d; g++) { var h = e[g]; if (h && h[a]) h[a]() } } } } };
...
(function() {
    ...
    d.AmChart = d.Class({
        ...
        showBalloon: function(a, b, c, e, d) {
            ...
            g.balloonTO = setTimeout(function() { g.showBalloonReal.call(g, a, b, c, e, d) }, 1)
        },
...
(function() {
    ...
    d.wedge = function(a, b, c, e, f, g, h, k, l, m, n, p, t, r) {
        ...
        var w = 1 / 180 * Math.PI,
            ...
            E = { fill: d.adjustLuminosity(m.fill, -.2), "stroke-opacity": 0, "fill-opacity": m["fill-opacity"] },
            H = 0;
        180 < Math.abs(f) && (H = 1);
        e = a.set();
        var G;
    ...
    d.AmLegend = d.Class({
        ...
        createEntry: function(a) {
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                void 0 !== b.tabIndex && (p.setAttr("tabindex", b.tabIndex), p.setAttr("role", "menuitem"), p.keyup(function(c) { 13 == c.keyCode && b.clickMarker(a, c) }));
...
(function() {
    ...
    d.AmMap = d.Class({
        ...
        drawBg: function() {
            ...
            a.background.mouseover(function() { a.rollOutMapObject(a.previouslyHovered) })
        },
        ...
        animateMap: function() {
            ...
            a.tweenPercent = 0;
            a.balloon.hide(0);
            setTimeout(function() { a.updateSize.call(a) }, 1E3 / d.updateRate)
        },
        updateSize: function() {
            var a = this,
                b = a.totalFrames;
            a.preventHover = !0;
            a.frame <= b ? (a.frame++, b = d.easeOutSine(0, a.frame, 0, 1, b), 1 <= b ? (b = 1, a.preventHover = !1, a.wheelBusy = !1) : window.requestAnimationFrame ? window.requestAnimationFrame(function() { a.updateSize.call(a) }) : setTimeout(function() { a.updateSize.call(a) }, 1E3 / d.updateRate), .8 < b && (a.preventHover = !1)) : (b = 1, a.preventHover = !1, a.wheelBusy = !1);
            a.tweenPercent = b;
        ...
        buildSVGMap: function() {
            ...
            for (e = 0; e < a.length; e++) {
                ...
                var k = b.path(g);
                k.id = f.id;
                if (this.areasSettings.preserveOriginalAttributes) { k.customAttr = {}; for (var l in f) "d" != l && "id" != l && "title" != l && (k.customAttr[l] = f[l]) }
        ...
        addObjectEventListeners: function(a, b) {
            var c = this;
            a.mousedown(function(a) { c.mouseDownMapObject(b, a) }).mouseup(function(a) { c.clickMapObject(b, a) }).mouseover(function(a) {
                c.balloonX = NaN;
            ...
            }).keyup(function(a) { 13 == a.keyCode && c.clickMapObject(b, a) })
        },
        ...
        showAsRolledOver: function(a) {
            ...
            if (!a.showAsSelected && b && !a.isOver) {
                ...
                if (void 0 != c)
                    ...
                    else if ("MapLine" == a.objectType) { if ((e = a.lineSvg) && e.setAttr("stroke", c), e = a.arrowSvg) e.setAttr("fill", c), e.setAttr("stroke", c) } else b.setAttr("fill", c);
        ...
        mouseDownMapObject: function(a, b) { this.fire({ type: "mouseDownMapObject", mapObject: a, chart: this, event: b }) },
        clickMapObject: function(a, b) {
            ...
            if (c.chartCreated && !c.preventHover && c.checkTouchDuration(b) && !c.mapWasDragged && c.checkIfClickable(a) && !c.mapWasPinched) {
                ...
                b && b.touches && setTimeout(function() { c.showBalloonAfterZoom.call(c) }, 1E3 * c.zoomDuration);
        ...
        checkIfClickable: function(a) { var b = this.allowClickOnSelectedObject; return this.selectedObject == a && b ? !0 : this.selectedObject != a || b ? !0 === a.selectable || "MapArea" == a.objectType && a.autoZoomReal || a.url || a.linkToObject || 0 < a.images.length || 0 < a.lines.length || !isNaN(a.zoomLevel) || !isNaN(a.zoomX) || !isNaN(a.zoomY) || a.description ? !0 : !1 : !1 },
        resizeMap: function() {
            var a = this.mapSet;
            if (a) {
                var b = 1,
        ...
        showDescriptionAndGetUrl: function() {
            ...
            if (a) {
                ...
                if (b) d.getURL(b, a.urlTarget);
                    ...
                    if (d.isString(b)) { var c = this.getObjectById(b); if (c) { this.selectObject(c); return } }
        ...
        recalcLongitude: function(a) { return this.dataProvider.wrappedLongitudes ? a < this.dataProvider.leftLongitude ? Number(a) + 360 : a : a },
        ...
        getXY: function(a,
            b, c) { void 0 !== a && (-1 != String(a).indexOf("%") ? (a = Number(a.split("%").join("")), c && (a = 100 - a), a = Number(a) * b / 100) : c && (a = b - a)); return a },
        ...
        getObject: function(a, b) { if (b) { var c; for (c = 0; c < b.length; c++) { var d = b[c]; if (d.id == a) return d; if (d.areas) { var f = this.getObject(a, d.areas); if (f) return f } if (f = this.getObject(a, d.images)) return f; if (d = this.getObject(a, d.lines)) return d } } },
        parseData: function() {
            var a = this.dataProvider;
        ...
        x2c: function(a) { var b = this.dataProvider.leftLongitude; return Math.round(this.unscaledMapWidth * (a - b) / (this.dataProvider.rightLongitude - b) * 100) / 100 },
    ...
    d.ZoomControl = d.Class({
        ...
        init: function(a, b) {
            ...
            if (g) {
                ...
                c.set = e;
                c.zoomSet = F;
                5 < q && (g = d.rect(b, f + 6, q + 2 * f + 6, c.gridBackgroundColor, c.gridBackgroundAlpha, 0, "#000000", 0, 4), d.setCN(a, g, "zoom-bg"), g.translate(-3, -3), g.mouseup(function() { c.handleBgUp() }).touchend(function() { c.handleBgUp() }), F.push(g));
                var E = f;
                A && (E = f / 1.5);
                c.draggerSize = E;
...
(function() {
    ...
    d.SimpleButton = d.Class({
        ...
        init: function(a, b, c, e, f, g, h, k, l, m, n, p, t) {
            ...
            e.mousedown(function() { r.handleDown() }).touchstart(function() { r.handleDown() }).mouseup(function() { r.handleUp() }).touchend(function() { r.handleUp() }).mouseover(function() { r.handleOver() }).mouseout(function() { r.handleOut() });
            r.bg = e
        },
            ...
            if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                if (0 < v.length) {
                    ...
                    if (isNaN(q)) {
                        ...
                        u = 1;
                        0 > w && (u = 0);
                        B = { fill: "none", stroke: l, "stroke-opacity": 1, "stroke-width": F / n, "fill-opacity": 0, "stroke-linecap": "round" };
                        ...
                        q = x.path(k).attr(B);
                        l = x.path(k).attr({ "fill-opacity": 0, stroke: l, "stroke-width": 5 / n, "stroke-opacity": .001, fill: "none" })
                    }
...
(function() {
    ...
    d.hex2RGB = function(a) { return [parseInt(a.substring(1, 3), 16), parseInt(a.substring(3, 5), 16), parseInt(a.substring(5, 7), 16)] };
    ...
    d.mercatorLatitudeToRadians = function(a) { return Math.log(Math.tan(Math.PI / 4 + d.degreesToRadians(a) / 2)) };
    ...
    d.acos = function(a) { return 1 < a ? 0 : -1 > a ? Math.PI : Math.acos(a) };
    d.asin = function(a) { return 1 < a ? Math.PI / 2 : -1 > a ? -Math.PI / 2 : Math.asin(a) };
    d.sinci = function(a) { return a ? a / Math.sin(a) : 1 };
    d.asqrt = function(a) { return 0 < a ? Math.sqrt(a) : 0 };
    d.winkel3 = function(a, b) { var c = d.aitoff(a, b); return [(c[0] + a / Math.PI * 2) / 2, (c[1] + b) / 2] };
    ...
    d.orthographic =
        function(a, b) { return [Math.cos(b) * Math.sin(a), Math.sin(b)] };
    d.equirectangular = function(a, b) { return [a, b] };
    d.equirectangular.invert = function(a, b) { return [a, b] };
    d.eckert5 = function(a, b) { var c = Math.PI; return [a * (1 + Math.cos(b)) / Math.sqrt(2 + c), 2 * b / Math.sqrt(2 + c)] };
    ...
    d.mercator.invert = function(a, b) { return [a, 2 * Math.atan(Math.exp(b)) - Math.PI / 2] };
    d.miller = function(a, b) { return [a, 1.25 * Math.log(Math.tan(Math.PI / 4 + .4 * b))] };
