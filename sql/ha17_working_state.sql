...
--
-- Host: localhost:3306
-- Generation Time: Sep 03, 2017 at 08:09 AM
...
(1, 'This is a test announcement.', NULL),
(2, 'announcement 2', NULL);
...
(11, 'level_11', 1000, 1, 'This gets tricky now....<br>A spy in my competitor\'s company have logged into the system of the company...<br>But the problem is, an important file that I want can be accessed only by a super user.<br>So your objective is to gain super user permission on the system.<br>My spy will take care of rest of the work.<br>But it might be a cake-walk for you!!!<br>It\'s a Bad Time for you!', 2, 1),
...
('eea09a9d251dcbccbc1fe4bf3f0651ee2485eb54', 15, 1504406120, 1504406325, '::1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.101 Safari/537.36', 1);
...
(19, 'tester', '8487047c2b178026cdb6b75812b2ffd3617d52ed', 0, 1000, NULL, 'splender@yopmail.com', 'test', 'NOT17OUT', '', NULL, NULL, '9876543210', 2, 1);
